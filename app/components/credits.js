...
function Header(props) {
    return (
        <div className="header"><h2 className="center">Credits</h2></div>
    )
}
    ...
    render() {
        return (
            <div className="container">
                <Header />
                <div className="body">
                    {this.state.loading? <div className="center-middle"><Loading /></div>:<div className="center-middle"><DisplayCredits /></div>}
                </div>
                <Footer />
            </div>
        )
