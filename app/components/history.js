...
function Header(props) {
    return (
        <div className="header"><h2 className="center">History</h2></div>
    )
}
...
function DisplayHistoryList(props) {
    return (
        <div className="loading">
    ...
    render() {
        return (
            <div className="container">
                <Header />
                <div className="body">
                    {this.state.loading? <div className="center-middle"><Loading /></div>:<div className="center-middle"><DisplayHistoryList /></div>}
                </div>
                <Footer />
            </div>
        )
